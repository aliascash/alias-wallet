...
#
# building_env.py - Build environment setup script for XZ/LZMA library
#
# Creates a building environment for XZ library:
# - Sets working directory
# - On Windows: uses MSYS bash for command execution (XZ's scripts need an UNIX-like environment)
...
if os_s == "LINUX_CROSS_ANDROID":
    ...
    env_file_path = os.path.join(binary_berkeleydb_dir_source, "../../../buildenv.txt")
...
proc = None
if os_s == "WIN32":
    # We must emulate a UNIX environment to build XZ using MinGW/MSYS
