...
#
# BuildTor.cmake - CMake module for building Tor from source
#
# This module handles the complete build process for Tor, including:
...
# - External project setup for downloading and building Tor
...
#    file(COPY ${libzstd_SOURCE_DIR}/../../../lib/zstd.h DESTINATION ${TOR_LIBTOR_PREFIX}/../libzstd/build/cmake/include/)
    ...
    elseif(CROSS_ANDROID)
        ...
        # Use gold linker for better Android compatibility
        ...
        # Additional configure script parameters for Android build
        # These configure Tor with Android-specific options and dependencies
        ...
        # Additional configure script parameters for native Unix build
        # Note: ZSTD and LZMA options are commented out but can be enabled if needed
        # ZSTD_CFLAGS='-I${TOR_LIBTOR_PREFIX}/../libzstd/build/cmake/include'
        # ZSTD_LIBS='-L${TOR_LIBTOR_PREFIX}/../libzstd/build/cmake/lib -lzstd'
        # LZMA_CFLAGS='-I${TOR_LIBTOR_PREFIX}/../usr/local/include'
        # LZMA_LIBS='-L${TOR_LIBTOR_PREFIX}/../usr/local/lib -llzma'
    ...
    # Add ExternalProject target for building Tor from source
    # This downloads, patches, configures, builds, and installs Tor
    ExternalProject_Add(libtorExternal
            ...
            # Note: Dependencies can be added here if needed
            # DEPENDS ssl_lib zstd event

            # Apply patches for Android compatibility and OpenSSL fixes
