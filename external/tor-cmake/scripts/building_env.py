...
#
# building_env.py - Build environment setup script for Tor
#
# Creates a building environment for Tor:
# - Sets working directory
# - On Windows: uses MSYS bash for command execution (Tor's scripts need an UNIX-like environment)
...
proc = None
if os_s == "WIN32":
    # We must emulate a UNIX environment to build Tor using MinGW/MSYS
