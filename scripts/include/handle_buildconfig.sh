...
##### ### # Tor # ### #######################################################
# Tor 0.4.1.6 (2019) is rejected by the current Tor network, which breaks all
# connections network-wide. Bumped to 0.4.8.11 to match the Windows build.
# Hash is the dist.torproject.org release tarball (see checkTorArchive source URL).
TOR_BUILD_VERSION=0.4.8.11
TOR_ARCHIVE_HASH=8f2bdf90e63380781235aa7d604e159570f283ecee674670873d8bb7052c8e07
