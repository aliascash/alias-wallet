# Overlay port for bzip2. The pinned 2021 vcpkg's stock port fetches the source
# with vcpkg_from_git from https://sourceware.org/git/bzip2.git, whose git
# endpoint is unreliable in CI (anonymous shallow SHA fetch intermittently fails
# with error 128), breaking cold builds. Fetch the identical bzip2 1.0.8 sources
# from the sourceware release tarball instead (what modern vcpkg does). Only the
# source acquisition differs from the stock port; everything below is unchanged.
