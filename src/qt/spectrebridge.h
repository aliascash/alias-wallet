...
private:
    ...
    QSortFilterProxyModel *ttm{nullptr};
...
public:
    explicit SpectreBridge(SpectreGUI *window, QObject *parent = nullptr);
    ~SpectreBridge();
...
private:
    SpectreGUI *window{nullptr};
    TransactionModel *transactionModel{nullptr};
    AddressModel *addressModel{nullptr};
    QList<SendCoinsRecipient> recipients;
    QVariantMap *info{nullptr};
    QThread *async{nullptr};
