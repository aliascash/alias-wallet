...
static const char *html_strings[] = {
    ...
    QT_TRANSLATE_NOOP("alias-bridge", "Start ALIAS on system login"),
    QT_TRANSLATE_NOOP("alias-bridge", "Detach databases at shutdown"),
    QT_TRANSLATE_NOOP("alias-bridge", "Pay transaction fee"),
    QT_TRANSLATE_NOOP("alias-bridge", "Transaction fee per kB. A higher fee makes sure your transactions are processed quickly in times of high transaction volume."),
    QT_TRANSLATE_NOOP("alias-bridge", "Most transactions are 1kB. The minimal fee is 0.0001"),
    QT_TRANSLATE_NOOP("alias-bridge", "Enable Staking"),
    QT_TRANSLATE_NOOP("alias-bridge", "Enables or disables the staking process. If your wallet is encrypted, you will need to unlock it for staking."),
    QT_TRANSLATE_NOOP("alias-bridge", "Staking Donation"),
    QT_TRANSLATE_NOOP("alias-bridge", "Every sixth block on the blockchain is a development contribution block (DCB). Staking rewards of DCBs are contributed to the development fund no matter the donation percentage setting. Please feel free to additionally donate from your remaining stake rewards by defining a donation chance. Thank you."),
    QT_TRANSLATE_NOOP("alias-bridge", "Reserve"),
    QT_TRANSLATE_NOOP("alias-bridge", "Reserved amount does not participate in staking and is therefore spendable at any time."),
    QT_TRANSLATE_NOOP("alias-bridge", "Minimum Stake Interval"),
    QT_TRANSLATE_NOOP("alias-bridge", "Main"),
    QT_TRANSLATE_NOOP("alias-bridge", "Window"),
    QT_TRANSLATE_NOOP("alias-bridge", "Display"),
    QT_TRANSLATE_NOOP("alias-bridge", "Minimize to the tray instead of the taskbar"),
    QT_TRANSLATE_NOOP("alias-bridge", "Minimize on close"),
    QT_TRANSLATE_NOOP("alias-bridge", "User Interface language"),
    QT_TRANSLATE_NOOP("alias-bridge", "Unit to show amounts in"),
    QT_TRANSLATE_NOOP("alias-bridge", "Rows per page"),
    QT_TRANSLATE_NOOP("alias-bridge", "Display addresses in transaction list"),
    QT_TRANSLATE_NOOP("alias-bridge", "Notifications"),
    QT_TRANSLATE_NOOP("alias-bridge", "Visible Transaction Types"),
